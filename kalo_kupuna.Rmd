...
par(mfrow = c(1, 3))
plot(factor(huli[, "Huli Variety"]), huli[, "Huli Mass (g)"], ylab = "Huli Mass (g)")
plot(factor(huli[, "Huli Variety"]), huli[, "Length to Node Apex (cm)"], ylab = "Length to Node Apex (cm)")
plot(factor(huli[, "Huli Variety"]), huli[, "Basal Diameter (mm)"], ylab = "Basal Diameter (mm)")
